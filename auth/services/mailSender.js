...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: config.get("cacb_emailAccount"),
    pass: process.env.CACB_MAIL_PASSWORD
  },
  tls: {
...
async function notifyOnOrgCreation(orgName, databaseName) {
  ...
  let info = {
    from:
      '"Flookup - Fixed Assets Register" ' + config.get("cacb_emailAccount"),
    to: config.get("cacb_emailAccount"),
